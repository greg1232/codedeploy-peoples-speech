...
eval $(parse_yaml $LOCAL_DIRECTORY/../configs/peoples_speech.yaml "")
...
docker pull ${AWS_ECR_REGISTRY_URL}/peoples-speech-deploy-service:latest

PEOPLES_SPEECH_TARGET="$(uname -m)" docker-compose -f deployment-root/$DEPLOYMENT_GROUP_ID/$DEPLOYMENT_ID/deployment-archive/scripts/docker-compose.yml up -d
